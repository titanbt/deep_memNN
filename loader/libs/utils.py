...
def load_word_embedding_dict(embedding, embedding_path, word_alphabet, logger=None, embedd_dim=200):
    """
    ...
    if embedding == 'word2vec':
        ...
        # loading doc2vec
        logger.info("Loading doc2vec ...")
        doc2vec = Doc2Vec.load(embedding_path)
        embedd_dim = doc2vec.vector_size
        return doc2vec, embedd_dim, False
